...
public class CreatePersonUseCase implements UseCase<CreatePersonInput, CreatePersonOutput> {
    ...
    public CreatePersonUseCase(PersonRepository personRepository, EmailUniquenessChecker emailUniquenessChecker, IdentificationNumberUniquenessChecker identificationNumberUniquenessChecker, PhoneNumberUniquenessChecker phoneNumberUniquenessChecker) {
